...
const float MAX_BASE=99.999;
const float MAX_BASE_INTEGER_LENGTH=2;
...
int main(){
    ...
    while (cin>>s>>n) {
        ...
        if(dotpos-valid_start>MAX_BASE_INTEGER_LENGTH){//input invalid,exit
            cout<<"base larger than "<<MAX_BASE<<endl;
            break;
        }
